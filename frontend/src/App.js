...
const strings = {
  es: {
    ...
    ui: {
      ...
      weight_label: "Peso",
      max_label: "Máx",
      allowed_dimensions: "Dimensiones permitidas (según reglas)",
  ...
  en: {
    ...
    ui: {
      ...
      weight_label: "Weight",
      max_label: "Max",
      allowed_dimensions: "Allowed dimensions (per rules)",
          ...
          <div className="mt-6">
            ...
            {status === "approved" && (
              <div className="mt-4 flex gap-3">
                <Button id="btn_finish_payment" variant="primary" onClick={() => nav("/start")}>{strings[kiosk.lang].ui?.finish || strings[kiosk.lang].finishCta}</Button>
              </div>
            )}
          </div>
        )}
