...
export const Button = ({ children, className = "", variant = "primary", style = {}, ...props }) => {
  const base = "px-8 py-5 text-[clamp(16px,2.2vh,22px)] font-extrabold uppercase tracking-wide rounded-[14px] focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 shadow-sm whitespace-nowrap";
  const styles = {
