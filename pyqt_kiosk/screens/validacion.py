...
class PantallaValidacion(QtWidgets.QWidget):
    def __init__(self, app):
        ...
        self.details.setStyleSheet("color:#374151")
        ...
        actions.addWidget(self.btnBack); actions.addWidget(self.btnOptions); actions.addWidget(self.btnFinish)
    ...
    def on_enter(self, payload: dict):
        ...
        rules = get_rules()
        result = validate(self.measure, rules)
